...
export default function LandingPage() {
  ...
  <div id="social-proof" data-section="social-proof">
      ...
      useInvertedBackground={false}
      names={[
        "Otomotiv Uzmanları",        "Kalite Kontrol A.Ş.",        "Araç Muayene Merkezi",        "Sigorta Destek",        "Yedek Parça Tedarik",        "Performans Tuning",        "Çevre Dostu Oto"]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        {
          id: "1",          name: "Ahmet Yılmaz",          role: "Mühendis",          company: "Tech Solutions",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-people-looking-car_23-2150171223.jpg",          imageAlt: "Ahmet Yılmaz fotoğrafı"},
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/young-handsome-business-man-choosing-car-car-showroom_1303-17894.jpg",          imageAlt: "Zeynep Kaya fotoğrafı"},
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/stylish-elegant-old-man-car-salon_1157-31926.jpg",          imageAlt: "Emre Aktaş fotoğrafı"},
      ]}
      kpiItems={[
        {
  ...
  <div id="about" data-section="about">
      ...
      bulletPoints={[
        ...
        {
          title: "Son Teknoloji Ekipmanlar",          description: "En yeni diagnostik cihazları ve tamir ekipmanlarıyla hızlı ve doğru çözümler sunuyoruz.",          icon: Cog,
        },
        {
          title: "Müşteri Memnuniyeti",          description: "Şeffaf fiyatlandırma, zamanında teslimat ve kaliteli hizmet anlayışımızla müşteri memnuniyeti odaklı çalışıyoruz.",          icon: Smile,
        },
        {
          title: "Geniş Hizmet Yelpazesi",          description: "Motor tamirinden periyodik bakıma, lastik değişiminden kaportaya kadar tüm ihtiyaçlarınız tek adreste.",          icon: Settings,
        },
      ]}
